...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ estou fazendo espere 2min se eu n�o responder pe�a dnv enquanto isso bata uma punheta que eu sei q voce nao dura mais de 2min ⌛',
				success: '✔️ Sucesso ✔️',
				...
				error: {
					stick: '[❗] Falha, ocorreu um erro ao converter a imagem em um adesivo so fa�o adesivo de 6segundos a menos ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❌',
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário! ❌',
					ownerB: '[❗] Este comando só pode ser usado pelo DANTE aquele gostoso! ❌',
					admin: '[❗] Este comando só pode ser usado por administradores de grupo retardado! ❌',
					Badmin: '[❗] Este comando só pode ser usado quando o bot se torna administrador animal ! ❌',
                                        daftarB: `── 「REGISTRE-SE」 ──\nOlá como!\nVocê não está registrado no banco de dados, \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar DANTE|17`,
				}
			}
			...
			const ownerNumber = ["5575982692667@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5575982692667@s.whatsapp.net'
                        /******ApiKey Input******/
